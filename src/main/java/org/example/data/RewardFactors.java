...
public class RewardFactors {
  ...
  public static double NEAR_ENEMY_REWARD_FACTOR = 0;
  public static double TRANSITION_NEIGHBOR_REWARD_FACTOR = 0;
  public static double SMALL_CONTINENT_REWARD_FACTOR = 2;
  public static double BIG_CONTINENT_REWARD_FACTOR = 1;
  public static double OCCUPIED_CONTINENT_REWARD_FACTOR = 2;
  public static double OCCUPIED_CONTINENT_ADDITIONAL_FOR_EACH_TERRITORY_ALREADY_OCCUPIED_REWARD_FACTOR = 1.2;
