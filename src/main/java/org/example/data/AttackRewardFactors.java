...
public class AttackRewardFactors {
  ...
  public static double LESS_TROOPS_FOR_ATTACK = -100;
  public static double ONE_MORE_UNIT_FOR_ATTACK = 2;
  public static double TWO_MORE_UNITS_FOR_ATTACK = 10;
  public static double THREE_OR_MORE_UNITS_FOR_ATTACK = 20;
  public static double REINFORCED_TERRITORY_WITHOUT_ENEMY_NEARBY = -20;
  public static double REINFORCED_TERRITORY_WITH_MORE_ENEMY_TROOPS_NEARBY = 10;
  public static double REINFORCED_TERRITORY_AND_HAS_MORE_TROOPS_THAN_ENEMY_AFTER = 20;
  public static double FORTIFIED_TERRITORY_CLOSER_TO_ENEMY = 10;
  public static double FORTIFIED_TERRITORY_NOT_CLOSER_TO_ENEMY = -5;
}
